...
Notes:
    * For Testing system art used *dummy roms* and all-in-one `metadata.pegasus.txt`: [pegasus-frontend-dummy-roms](https://github.com/LeeBigelow/pegasus-frontend-dummy-roms/tree/main)
    * For game art used mixed image screenshots generated by: [Skyscraper](https://github.com/Gemba/skyscraper/tree/master)
